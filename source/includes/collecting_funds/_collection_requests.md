...
send_instructions | boolean | Whether or not Beyonic will attempt to send instructions to the user
expiry_date | string or null | A future date and time that a collection request will be marked as expired. Examples of valid values for this field include strings such as "tomorrow", "24 hours", "2 minutes", or %d/%m/%Y format e.g 24/05/2019 or %d/%m/%Y %H:%M:%S format e.g 24/05/2019 13:24:12
